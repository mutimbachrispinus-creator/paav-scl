...
export async function kvUpdateStaffAvatar(id, avatar, tenantId = 'paav-gitombo') {
  await ensureSchema();
...
export async function kvUpdateStaffProfile(id, name, phone, avatar, password = null, tenantId = 'paav-gitombo') {
  await ensureSchema();
  if (password) {
...
export async function kvUpdateLearnerAvatar(adm, avatar, tenantId = 'paav-gitombo') {
  await ensureSchema();
 ...
 */
export async function kvGet(key, defaultValue = null, tenantId = 'paav-gitombo') {
  await ensureSchema();
 ...
 */
export async function kvGetWithMeta(key, tenantId = 'paav-gitombo') {
  await ensureSchema();
 ...
 */
export async function kvUpdateLearner(oldAdm, details, tenantId = 'paav-gitombo') {
  await ensureSchema();
 ...
 */
export async function kvSet(key, value, tenantId = 'paav-gitombo') {
  await ensureSchema();
 ...
 */
export async function kvUpdateMark(grade_subj_assess, adm, score, tenantId = 'paav-gitombo') {
  if (score === null || score === undefined || score === '') {
 ...
 */
export async function kvUpdateMarksBulk(marksList, tenantId = 'paav-gitombo') {
 ...
 */
export async function kvUpdateAttendanceBulk(attMap, tenantId = 'paav-gitombo') {
 ...
 */
export async function kvUpsertMessage(msg, tenantId = 'paav-gitombo') {
 ...
 */
export async function kvSubmitStaffRequest(req, tenantId = 'paav-gitombo') {
 ...
 */
export async function kvLogPresence(userId, date, record, tenantId = 'paav-gitombo') {
  await ensureSchema();
  await execute(
 ...
 */
export async function kvUpsertDuty(duty, tenantId = 'paav-gitombo') {
 ...
 */
export async function kvDeleteDuty(id, tenantId = 'paav-gitombo') {
  await ensureSchema();
 ...
 */
export async function kvUpdateStaffRequestStatus(id, status, tenantId = 'paav-gitombo') {
  await ensureSchema();
 ...
 */
export async function kvRecordPayment({ adm, term, amount, method, ref, by, status = 'approved' }, tenantId = 'paav-gitombo') {
  await ensureSchema();
 ...
 * Delete a key.
 */
export async function kvDelete(key, tenantId = 'paav-gitombo') {
  await ensureSchema();
 ...
 */
export async function kvTimestamps(keys, tenantId = 'paav-gitombo') {
  await ensureSchema();
