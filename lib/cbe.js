...
// Default to CBC for legacy support
const defaultCurr = getCurriculum('CBC');

export const PRE         = defaultCurr.PRE;
export const LOWER       = defaultCurr.LOWER;
export const UPPER       = defaultCurr.UPPER;
export const JSS         = defaultCurr.JSS;
export const SENIOR      = defaultCurr.SENIOR;
export const ALL_GRADES  = defaultCurr.ALL_GRADES;
export const DEFAULT_SUBJECTS = defaultCurr.DEFAULT_SUBJECTS;
export const JSS_SCALE   = defaultCurr.JSS_SCALE;
export const PRIMARY_SCALE = defaultCurr.PRIMARY_SCALE;
