...
export const DEFAULT_SUBJECTS = {
  ...
  'GRADE 10': ['English','Kiswahili','Mathematics','Integrated Science','Social Studies','Business Studies','Agriculture','Pre-Technical','CRE/IRE','Creative Arts','Life Skills','Physical Education','Community Service Learning'],
  'GRADE 11': ['English','Kiswahili','Mathematics','Biology','Chemistry','Physics','History','Geography','CRE/IRE','Computer Science','Business Studies','Agriculture','Home Science','Physical Education','Community Service Learning'],
  'GRADE 12': ['English','Kiswahili','Mathematics','Biology','Chemistry','Physics','History','Geography','CRE/IRE','Computer Science','Business Studies','Agriculture','Home Science','Physical Education','Community Service Learning'],
};
