...
export const ROLE_PAGES = {
  ...
  'super-admin': ['super-admin', 'dashboard','learners','grades','attendance','fees','teachers','timetable','performance',
            'salary','duties','streams','reports','templates','sms','messages','profile',
            'audit','settings','merit-list','classes','allocations'],
...
export async function getSession() {
  try {
    ...
    // During static generation (prerendering), cookies() may throw or be unavailable.
    return null;
  }
}
