...
export const ALL_NAV = [
  ...
  { key:'welfare/portfolio', label:'Achievements', icon:'🎨', roles:['admin', 'teacher', 'parent'],
    prefetch: ['paav6_learners', 'paav7_portfolio'] },

  { key:'finance', label:'Finance',     icon:'💰', roles:['admin'],
    prefetch: ['paav7_ledger', 'paav6_learners'] },

  { key:'finance/expenses', label:'Expenses',     icon:'🧾', roles:['admin'],
    prefetch: ['paav7_expenses'] },

  { key:'finance/payroll',  label:'Payroll',      icon:'🇰🇪', roles:['admin'],
    prefetch: ['paav6_staff'] },

  { key:'finance/reconcile', label:'Reconcile',    icon:'🏦', roles:['admin'],
