...
export const ALL_NAV = [
  ...
  { key:'learners',    label:'Learners', icon:'👥', roles:['admin','teacher','staff'] },
  ...
  { key:'learning',    label:'Education Hub', icon:'🎓', roles:['admin','teacher','staff','parent'] },
  { key:'duties',      label:'Duties', icon:'📋', roles:['admin','teacher','staff'] },
  { key:'settings/streams', label:'Streams', icon:'🌊', roles:['admin'] },
