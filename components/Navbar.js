      ...
      <Link href="/dashboard" className="tb-brand" style={{ cursor: 'pointer', textDecoration: 'none' }}>
        ...
        <div>
          <div className="tb-sname" style={(user.role === 'super-admin' && !impersonateId) ? {
            ...
            {(user.role === 'super-admin' && !impersonateId) ? 'EduVantage' : (profile.name === 'PAAV-Gitombo Community School' ? 'EduVantage School Management System' : (profile.name?.toUpperCase() || 'SCHOOL PORTAL'))}
