...
var $ = /* @__PURE__ */ __name((e, t, s) => (s = e != null ? se(ce(e)) : {}, ie(t || !e || !e.__esModule ? U(s, "default", { value: e, enumerable: true }) : s, e)), "$");
var f;
var p = E(() => {
  f = { collectedLocales: [] };
});
...
async function J(e) {
  ...
  try {
    ...
    switch (e.method) {
      ...
      case "POST": {
        let c = globalThis[ye], a = /* @__PURE__ */ __name(async () => {
          let o = await e.json();
 ...
 * MIT Licensed
 */
//# sourceMappingURL=bundledWorker-0.6240233772534098.mjs.map
