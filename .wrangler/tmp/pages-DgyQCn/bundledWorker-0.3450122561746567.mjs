...
var rt = /* @__PURE__ */ __name((t, e, s, n) => {
  if (e && typeof e == "object" || typeof e == "function")
    for (let i of it(e))
      !ot.call(t, i) && i !== s && U(t, i, { get: () => e[i], enumerable: !(n = at(e, i)) || n.enumerable });
  return t;
}, "rt");
var $ = /* @__PURE__ */ __name((t, e, s) => (s = t != null ? st(ct(t)) : {}, rt(e || !t || !t.__esModule ? U(s, "default", { value: t, enumerable: true }) : s, t)), "$");
var y;
var p = M(() => {
  y = { collectedLocales: [] };
});
...
async function J(t) {
  ...
  try {
    ...
    switch (t.method) {
      ...
      case "POST": {
        let c = globalThis[gt], a = /* @__PURE__ */ __name(async () => {
          let o = await t.json();
 ...
 * MIT Licensed
 */
//# sourceMappingURL=bundledWorker-0.3450122561746567.mjs.map
